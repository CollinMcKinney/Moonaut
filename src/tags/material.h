...
const struct material_definition DEFAULT_MATERIAL_GRASS = {
    ...
    /*.diffuse_wrap        =*/ 1,
    /*.oren_nayar_sigma    =*/ 0.0f,                   /* rough fibrous surface */
    /*.minnaert_k          =*/ 0.0f,
...
const struct material_definition DEFAULT_MATERIAL_CLOTH = {
    ...
    /*.oren_nayar_sigma    =*/ 0.0f,          /* fabric roughness */
    /*.minnaert_k          =*/ 0.0f,
...
const struct material_definition DEFAULT_MATERIAL_WOOD = {
    ...
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* fibrous roughness */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_METAL = {
    ...
    /*.oren_nayar_sigma    =*/ 0.00f,
    /*.minnaert_k          =*/ 0.00f,
    /*.bump_amplitude      =*/ 0.03f,                   /* subtle brushed grain */
...
const struct material_definition DEFAULT_MATERIAL_SKIN = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 1,                       /* soft falloff */
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* skin-like roughness */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_RUBBER = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 1,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* fully rough */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_STONE = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 1,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* rough stone */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_LAVA = {
    ...
    /*.diffuse_wrap        =*/ 1,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* rougher surface */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_IRIDESCENT = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 0,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* very smooth surface */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_BRICK = {
    /*.mode                =*/ SHADE_GOURAUD,
    /*.color               =*/ {0.56f, 0.19f, 0.10f},   /* red-brown brick */
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 0,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* extremely rough */
    /*.minnaert_k          =*/ 0.00f,
    /*.bump_amplitude      =*/ 1.00f,                   /* extremely textured */
    /*.bump_frequency      =*/ 48.0f,
    /*.bump_speed          =*/ 0.00f,
    /*.gooch_cool          =*/ {0.35f, 0.12f, 0.06f},   /* dark shadows */
    /*.gooch_warm          =*/ {0.75f, 0.26f, 0.14f},   /* warm highlights */
    /*.back_glow_color     =*/ {0.00f, 0.00f, 0.00f},
    /*.rim_color           =*/ {0.62f, 0.21f, 0.11f},   /* muted rim */
    /*.rim_exponent        =*/ 0.50f,
    /*.fresnel_color       =*/ {0.00f, 0.00f, 0.00f},
    /*.fresnel_exponent    =*/ 0.00f,
    /*.specular_exponent   =*/ 0.00f,                    /* minimal shine */
    /*.specular_color      =*/ {0.00f, 0.00f, 0.00f},   /* brown highlights */
    /*.specular_threshold  =*/ 0.00f,
    /*.emissive_color      =*/ {0.00f, 0.00f, 0.00f},
    /*.emissive_pulse_frequency =*/ 0.00f,
    /*.emissive_pulse_phase     =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_LEATHER = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 1,                       /* soft falloff */
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* flexible roughness */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_GOLD = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 0,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* smooth metal */
    /*.minnaert_k          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_SNOW = {
    ...
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* powdery roughness */
    /*.minnaert_k          =*/ 0.00f,
    /*.bump_amplitude      =*/ 0.10f,                   /* uneven surface */
    /*.bump_frequency      =*/ 32.0f,
    /*.bump_speed          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_DIRT = {
    ...
    /*.cel_bands           =*/ 0,
    /*.diffuse_wrap        =*/ 1,
    /*.oren_nayar_sigma    =*/ 0.00f,                   /* rougher */
    /*.minnaert_k          =*/ 0.00f,
    /*.bump_amplitude      =*/ 0.30f,                   /* more pronounced texture */
    /*.bump_frequency      =*/ 32.0f,                   /* grainier */
    /*.bump_speed          =*/ 0.00f,
...
const struct material_definition DEFAULT_MATERIAL_NEON = {
    ...
    /*.ambient_light_factor=*/ 0.05f,                   /* allow emissive to show */
    /*.alpha               =*/ 1.00f,
    /*.saturation          =*/ 15.00f,
    ...
    /*.strobe_color        =*/ {0.00f, 2.00f, 2.00f},   /* bright blue flashes */
    /*.strobe_frequency    =*/ 8.00f,
    /*.strobe_phase        =*/ 0.25f,
    /*.skip_fog            =*/ 1,                       /* glow through fog */
