                                     ...
                                     const tile_bounds *bounds)
{
    ...
    dc0 = vec3_init_from_3(0, 0, 0);
    dc1 = vec3_init_from_3(0, 0, 0);
    dc2 = vec3_init_from_3(0, 0, 0);
    ...
    const tile_bounds *bounds)
{
    ...
    dnw0 = vec3_init_from_3(0, 0, 0);
    dnw1 = vec3_init_from_3(0, 0, 0);
    dnw2 = vec3_init_from_3(0, 0, 0);
    ...
    for (y = y_start; y < y_end; y++)
    {
        ...
        else
        {
            ...
            nwe_x = n0w.position.x + dnw2.position.x * (y - y0);
            nwe_y = n0w.position.y + dnw2.position.y * (y - y0);
            nwe_z = n0w.position.z + dnw2.position.z * (y - y0);
            wps_x = wp1w.position.x + dwpw1.position.x * t;
            wps_y = wp1w.position.y + dwpw1.position.y * t;
            wps_z = wp1w.position.z + dwpw1.position.z * t;
            wpe_x = wp0w.position.x + dwpw2.position.x * (y - y0);
            wpe_y = wp0w.position.y + dwpw2.position.y * (y - y0);
            wpe_z = wp0w.position.z + dwpw2.position.z * (y - y0);
            lps_x = lp1w.position.x + dlpw1.position.x * t;
            lps_y = lp1w.position.y + dlpw1.position.y * t;
            lps_z = lp1w.position.z + dlpw1.position.z * t;
            lpe_x = lp0w.position.x + dlpw2.position.x * (y - y0);
            lpe_y = lp0w.position.y + dlpw2.position.y * (y - y0);
            lpe_z = lp0w.position.z + dlpw2.position.z * (y - y0);
        }
